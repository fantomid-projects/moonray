...
public:
    ...
    virtual void setTransform(const shading::XformSamples& xforms,
                              ...
                              float shutterCloseDelta) override;
...
private:
    ...
    generateSubdQuadTopology(const scene_rdl2::rdl2::Layer* pRdlLayer,
    ...
    void generateIndexBufferAndSurfaceSamples(const std::vector<SubdQuadTopology>& quadTopologies,
    ...
    void generateControlMeshIndexBufferAndSurfaceSamples(const std::vector<SubdQuadTopology>& quadTopologies,
                                                         const SubdTessellatedVertexLookup& tessellatedVertexLookup,
                                                         SubdivisionMesh::IndexBuffer& indices,
                                                         std::vector<LimitSurfaceSample>& limitSurfaceSamples,
