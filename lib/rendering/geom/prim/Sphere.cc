                      ...
                      Intersection& intersection) const
{
    ...
    Vec2f st(ray.u / mPhiMax,
             (theta - mThetaMin) / (mThetaMax - mThetaMin));

    Vec3f dpds = scene_rdl2::math::transformVector(mL2P,
                                                   Vec3f(-mPhiMax * pLocal.y,
                                                          mPhiMax * pLocal.x,
                                                          0.0f));
    ...
    Vec3f dpdt = scene_rdl2::math::transformVector(mL2P,
                                                   (mThetaMax - mThetaMin) * Vec3f(pLocal.z * cosPhi,
                                                                                   pLocal.z * sinPhi,
                                                                                   -mRadius * sinf(theta)));
