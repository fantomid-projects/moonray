...
{
public:
    LineSegmentsInterpolator(const Attributes *attr,
                             float time,
                             int chain,
                             float u,
                             int vertexOffset) :
...
LineSegments::LineSegments(Curves::Type type,
                            ...
                            Intersection& intersection) const
{
    ...
    const AttributeTable *table = intersection.getMaterial()->get<shading::Material>().getAttributeTable();
    ...
    if (table->requests(StandardAttributes::sMotion)) {
        ...
        if (isMotionBlurOn()) {
            ...
            const Vec3fa v0 = lerp(lerp(mVertexBuffer(vertexOffset + 0, 0),
                                        mVertexBuffer(vertexOffset + 0, 1),
                                        wc),
                                   lerp(mVertexBuffer(vertexOffset + 1, 0),
            ...
            const Vec3fa v1 = lerp(lerp(mVertexBuffer(vertexOffset + 0, 0),
                                        mVertexBuffer(vertexOffset + 0, 1),
                                        wc),
                                   lerp(mVertexBuffer(vertexOffset + 1, 0),
                                        mVertexBuffer(vertexOffset + 1, 1),
            ...
            const Vec3fa v0 = lerp(mVertexBuffer(vertexOffset + 0, 0),
                                   mVertexBuffer(vertexOffset + 1, 0),
                                   ray.u);
