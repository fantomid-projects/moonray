...
{
    explicit Impl(internal::AmorphousVolume* vol) :
        mAmorphousVolume(vol) {}
...
AmorphousVolume::AmorphousVolume(const VdbInitData& vdbInitData,
    ...
    mImpl(fauxstd::make_unique<Impl>(new internal::AmorphousVolume(vdbInitData.mVdbFilePath,
...
void
AmorphousVolume::transformPrimitive(const MotionBlurParams& motionBlurParams,
