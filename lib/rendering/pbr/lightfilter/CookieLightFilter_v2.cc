...
bool CookieLightFilter_v2::sAttributeKeyInitialized;
rdl2::AttributeKey<rdl2::SceneObject*> CookieLightFilter_v2::sProjectorKey;
rdl2::AttributeKey<rdl2::Mat4d> CookieLightFilter_v2::sProjectorXformKey;
rdl2::AttributeKey<rdl2::Int> CookieLightFilter_v2::sProjectorTypeKey;
rdl2::AttributeKey<rdl2::Float> CookieLightFilter_v2::sProjectorFocalKey;
rdl2::AttributeKey<rdl2::Float> CookieLightFilter_v2::sProjectorFilmWidthApertureKey;
rdl2::AttributeKey<rdl2::Float> CookieLightFilter_v2::sProjectorPixelAspectRatioKey;
rdl2::AttributeKey<rdl2::Float> CookieLightFilter_v2::sBlurNearDistanceKey;
rdl2::AttributeKey<rdl2::Float> CookieLightFilter_v2::sBlurMidpointKey;
rdl2::AttributeKey<rdl2::Float> CookieLightFilter_v2::sBlurFarDistanceKey;
rdl2::AttributeKey<rdl2::Float> CookieLightFilter_v2::sBlurNearValueKey;
rdl2::AttributeKey<rdl2::Float> CookieLightFilter_v2::sBlurMidValueKey;
rdl2::AttributeKey<rdl2::Float> CookieLightFilter_v2::sBlurFarValueKey;
rdl2::AttributeKey<rdl2::Int> CookieLightFilter_v2::sBlurType;
rdl2::AttributeKey<rdl2::Int> CookieLightFilter_v2::sOutsideProjection;
rdl2::AttributeKey<rdl2::Float> CookieLightFilter_v2::sDensityKey;
rdl2::AttributeKey<rdl2::Bool> CookieLightFilter_v2::sInvertKey;
rdl2::AttributeKey<rdl2::String> CookieLightFilter_v2::sTextureKey;
rdl2::AttributeKey<rdl2::Rgb> CookieLightFilter_v2::sGammaKey;


HUD_VALIDATOR(CookieLightFilter_v2);
    ...
    mDistribution(nullptr)
{
    ...
    ispc::CookieLightFilter_v2_init((ispc::CookieLightFilter_v2 *)this->asIspc());
}

CookieLightFilter_v2::~CookieLightFilter_v2()
{
    delete mDistribution;
}

void
CookieLightFilter_v2::initAttributeKeys(const rdl2::SceneClass &sc)
{
    ...
    sTextureKey = sc.getAttributeKey<rdl2::String>("texture");
    sGammaKey = sc.getAttributeKey<rdl2::Rgb>("gamma");

    MOONRAY_FINISH_NON_THREADSAFE_STATIC_WRITE
}

math::Mat4f
CookieLightFilter_v2::computePerspectiveProjectionMatrix(float t) const
{
    // Get focal length (mm)
...
math::Mat4f
CookieLightFilter_v2::computeOrthoProjectionMatrix(float t) const
{
    // Get film-back width (mm)
    float filmWidth = mRdlLightFilter->get(sProjectorFilmWidthApertureKey);
    filmWidth = max(filmWidth, 0.01f);
...
bool
CookieLightFilter_v2::isValidXform(const Mat4d& xf)
{
...
void
CookieLightFilter_v2::update(const LightFilterMap& /*lightFilters*/,
...
bool
CookieLightFilter_v2::canIlluminate(const CanIlluminateData& data) const
{
...
bool
CookieLightFilter_v2::needsSamples() const {
    return mBlurNearValue > 0.f || mBlurMidValue > 0.f || mBlurFarValue > 0.f;
}

Color
CookieLightFilter_v2::eval(const EvalData& data) const
{
    Vec3f projectorPos = lerp(mProjectorPos[0], mProjectorPos[1], data.time);
    Vec3f projectorDir = lerp(mProjectorDir[0], mProjectorDir[1], data.time);
    Vec3f shadingVec = data.shadingPointPosition - projectorPos;
